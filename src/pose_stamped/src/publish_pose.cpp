...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
        ...
        msg.pose.orientation.z = (int(count)%20)/20.0;;
        msg.pose.orientation.w = sqrt(1.0 - msg.pose.orientation.x*msg.pose.orientation.x+msg.pose.orientation.y*msg.pose.orientation.y+msg.pose.orientation.z*msg.pose.orientation.z);

...
int main(int argc, char **argv)
{
    ...
    std::string input_lidar_path = "/home/lyh/lab/data/livox_0904/2020-09-04_17-51-16.csv";
    int pts_per_packet = 10000;
    int start_time = 36036;
//    int start_time = 0;
    int end_time = 36473;
    char s[1000] = {0};
    ...
    while(!tf.eof())
    {
        ...
        substr = split(s,',');
        double cur_time = atof(substr[0].c_str());
        ...
        double x =  atof(substr[1].c_str())/1e3;
        double y =  atof(substr[2].c_str())/1e3;
        double z =  atof(substr[3].c_str())/1e3;
